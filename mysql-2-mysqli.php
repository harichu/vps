...
if (!extension_loaded('mysql') && !function_exists('mysql_connect')) {
	...
	/**
	 * Store the mysqli connection in a global space when using mysql_connect
	 * if you want to use another connection that you build with mysqli_connect
	 * you can either overwrite the global connection or pass the connection
	 * to the respective function
	 * 
	 */
	$GLOBALS['mysqli_connection'] = null;
